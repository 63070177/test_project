  ...
  <nav style="background:white; height:10%;">
    <div class="row align-items-center">
      <div class="d-flex col-3 align-self-center">
        <img src="../assets/pink-ribbon.png" alt="" style="margin:10px; width:10%; height:10%;" />
      ...
      <div class="card-body">
        <div class="col" style="padding: 20px; padding-top: 40px;">
          <form>
            ...
            <div class="row" style="margin-bottom:20px;">
              <label for="exampleInputPassword1" class="form-label"><b>รหัสผ่าน</b></label>
              <input type="password" v-model="psw" class="form-control" id="exampleInputPassword1" required>
            </div>
            <div class="row">
              <button type="button" class="btn btn-block" style="background-color:#0A6B3A; color: #ffffff;"
