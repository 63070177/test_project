...
export default {
  ...
  methods: {
    ...
    goYes() {
      if (this.addMedName == '') {
        alert('กรุณากรอกชื่อสูตรยาเคมีบำบัด')
      } else if (this.addNumberOfRound == null) {
        alert('กรุณากรอกจำนวนรอบการรับยา')
      } else if (this.addPeriod == null) {
        alert('กรุณากรอกระยะห่างของการรับยา')
      } else if (isNaN(this.addNumberOfRound)) {
        alert('กรุณากรอกข้อมูลเป็นตัวเลข')
      } else if (isNaN(this.addPeriod)) {
        alert('กรุณากรอกข้อมูลเป็นตัวเลข2')
      }
      else {
        const data = {
