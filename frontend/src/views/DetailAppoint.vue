          ...
          <div class="card-body" style="text-align: left; padding: 30px">
            ...
            <div class="container" style="margin-bottom: 20px">
              <div class="row g-0">
                ...
                <div class="col-4">
                  เลขบัตรประจำตัวประชาชน : <b>{{ patient.IDcard }}</b>
                </div>
                <div class="col-4">
            ...
            <div v-for="t in treatment" :key="t.treatmentId">
              <div class="row g-0">
                <div class="col-4"><b>แผนการรักษา : </b>{{ t.cancerType }}</div>
            ...
            <div class="d-grid d-md-flex justify-content-md-end">
              <button
                v-if="patient.numberOfRound != this.appointment.length && user.type == 'nurse'"
                type="button"
                class="btn btn-success"
                  ...
                  <div class="modal-body">
                    <div class="mb-3 row" v-for="f in feedbacks" :key="f.feedbackId">
                      <label for="exampleFormControlInput1" class="col-sm-10 form-label"
                        ...
                        <p v-else-if="f.patientSideEffect != null">ผู้ป่วยบันทึกผลข้างเคียงแล้ว</p>
                        <p v-else-if="f.sendAt == null && f.sideEfflevel == null">ไม่มีบันทึกผลข้างเคียง</p>
                      ...
                      <div class="card-body">
                        <div class="container">
                          <div class="row">
                            ...
                            <div
                              v-if="(selectedFeedback.sideEfflevel == null || edit == true) && user.type == 'nurse'"
...
export default {
  ...
  mounted() {
    ...
    axios
      .get(`http://localhost:3000/detailPatient/${HN}`)
      .then((response) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        for (let i = 0; i < this.feedbacks.length; i++) {
          ...
          axios
            .get(`http://localhost:3000/myformula/${this.feedbacks[i].HN}/${this.feedbacks[i].treatmentId}`)
            .then((response) => {
  ...
  methods: {
      ...
      axios
        ...
        .then((response) => {
          ...
          for (let i = 0; i < this.appointment.length; i++) {
            ...
            axios
              .get(`http://localhost:3000/myformula/${this.appointment[i].HN}${this.appointment.treatmentId}`)
              .then((response) => {
                this.appointment[i].formulaName = response.data[0].formulaName;
              })
              .catch((error) => {
        ...
        axios
          ...
          .then((response) => {
            ...
            for (let i = 0; i < this.feedbacks.length; i++) {
              ...
              axios
                .get(`http://localhost:3000/myformula/${this.feedbacks[i].HN}/${this.feedbacks.treatmentId}`)
                .then((response) => {
                  this.feedbacks[i].formulaName = response.data[0].formulaName;
                })
                .catch((error) => {
      ...
      axios
        ...
        .then((response) => {
          ...
          for (let i = 0; i < this.posts.length; i++) {
            ...
            axios
              .get(`http://localhost:3000/myformula/${this.posts[i].HN}/${this.posts[i].treatmentId}`)
              .then((response) => {
                this.posts[i].formulaName = response.data[0].formulaName;
              })
              .catch((error) => {
                console.log(error);
              });
    ...
    openRequest(request) {
      ...
      this.selectedRequest.thaiNewappointDate = this.convertToThaiDate(date);
    ...
    chemsetPages() {
      let chemnumberOfPages = Math.ceil(this.chemposts.length / this.chemperPage);
      while (this.chempages.length > 0) {
        this.chempages.pop();
      }
      for (let index = 1; index <= chemnumberOfPages; index++) {
        this.chempages.push(index);
      }
    },
    chempaginate(chemposts) {
      let chempage = this.chempage;
      let chemperPage = this.chemperPage;
      let from = chempage * chemperPage - chemperPage;
      let to = chempage * chemperPage;
      return chemposts.slice(from, to);
    },
  },
  computed: {
    displayedPosts() {
      return this.chempaginate(this.chemposts);
    },
    shouldDisplay() {
